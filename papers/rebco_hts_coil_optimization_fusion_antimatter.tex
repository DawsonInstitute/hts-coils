...
\title{\Large\bfseries Computational Optimization Framework for REBCO High-Temperature Superconducting Coil Design with FEA Validation}

% Author details (inlined in frontmatter; explicit definitions removed to avoid conflicts)
% Use standard RevTeX author macros (affiliation then email)
