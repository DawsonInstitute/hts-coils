...
Antimatter research relies heavily on magnetic confinement, with CERN's Antihydrogen Laser Physics Apparatus (ALPHA) and AEgIS experiments successfully trapping antihydrogen using 1--5~T fields \cite{alpha2023,aegis2016antihydrogen}. Next-generation experiments require 5-10 T capabilities for enhanced trapping efficiency and precision measurements. Similarly, fusion applications demand precise field control, exemplified by the Soonest/Smallest Private-Funded Affordable Robust Compact (SPARC) tokamak's 20~T central solenoid \cite{sparc2020}.
...
\bibitem{aegis2016antihydrogen}
C. Amsler et al. (AEgIS collaboration), ``Pulsed production of antihydrogen,'' Communications Physics, vol. 4, no. 1, pp. 19, 2021.
...
\bibitem{brandt1993type}
E. H. Brandt and M. Indenbom, ``Type-II-superconductor strip with current in a perpendicular magnetic field,'' \textit{Physical Review B}, vol. 48, pp. 12893--12906, 1993.

\bibitem{selvamanickam2015progress}
Selvamanickam, V., Gharahcheshmeh, M.H., Xu, A., et al., ``Recent progress in second-generation HTS conductor scale-up at SuperPower,'' \textit{IEEE Transactions on Applied Superconductivity}, vol. 17, no. 2, pp. 6603304, 2007.

\bibitem{obradors2014coated}
Obradors, X., Puig, T., ``Coated conductors for power applications: materials challenges,'' \textit{Superconductor Science and Technology}, vol. 27, 044003, 2014.
