...
We validate the HTS magnet design using the framework implemented in \texttt{src/hts/}, with validation results documented in \texttt{validation\_results.json}.
