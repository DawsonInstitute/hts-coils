...
\textit{[Diagram showing integrated HTS-Plasma system:]}\\[0.3cm]
\textbf{1. HTS Magnetic System} $\rightarrow$ \textbf{2. Plasma Simulation}\\[0.2cm]
$\downarrow$ \hspace{3cm} $\downarrow$\\[0.2cm]
\textbf{5. Data Acquisition} $\leftarrow$ \textbf{3. Thermal Management}\\[0.2cm]
$\uparrow$ \hspace{3cm} $\downarrow$\\[0.2cm]
\textbf{4. Safety \& Control Systems}\\[0.3cm]
\textit{Integrated multi-physics framework for high-beta plasma confinement.}
\vspace{2cm}
\end{minipage}}
...
The plasma physics simulation employs hybrid Particle-in-Cell/Magnetohydrodynamic (PIC/MHD) methods to model high-beta plasma confinement with comprehensive electromagnetic coupling \cite{Maxwell1865,freidberg2014plasma}:
...
\item \textbf{Electromagnetic Integration}: Self-consistent field evolution with plasma current coupling following Maxwell's equations \cite{Maxwell1865}:
\begin{align}
